...
namespace SimpleQuiz.Admin.Services.Quizzes
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedIQuizzesGatewayService : IQuizzesGatewayService
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedIQuizzesGatewayService(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<QuizzesAndStatsOutputModel> IQuizzesGatewayService.All()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("All", new Type[] {  });
            return (Task<QuizzesAndStatsOutputModel>)func(Client, arguments);
        }
    }
}
